...
- **[FlashHead Benchmark](flashhead_benchmark.md)** — first real-hardware result for `soulx-flashhead-1.3b` through OmniRT's script-backed generation path; the current execution surface is `persistent_worker`
