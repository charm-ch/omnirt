...
<p class="omnirt-tagline">面向 CUDA 与 Ascend 的数字人链路多模态生成运行时。</p>
...
项目会继续保留已经适配的泛图像 / 泛视频模型，但后续主线不再按“模型越多越好”推进，而是优先打磨可部署、可复现、可 benchmark 的数字人垂直闭环。
...
- **Core**：数字人主链路，必须具备真实 smoke、benchmark 和部署文档，例如 `soulx-flashtalk-14b`、`soulx-liveact-14b`、`soulx-flashhead-1.3b`、`cosyvoice3-triton-trtllm`
